...
class PDFMergerApp:
    ...
    def add_file(self):
        ...
        if file_path:
            ...
            total_pages = len(PdfReader(open(file_path, "rb"), strict=False).pages)
            ...
            if self.file_count % 2 == 1:
                self.my_tree.insert(parent='', index='end', iid=str(self.file_count),
    ...
    # Moving selected records up and down the list
    ...
    # Incrementing value of first page for a particular file
    ...
    # Decrementing value of first page for a particular file
    ...
    # Incrementing value of last page for a particular file
    ...
    # Decrementing value of last page for a particular file
